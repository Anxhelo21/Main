...
public class Motorcycle extends Vehicle{ //main function for the subclass , extends ... assigns it as a subclass
	...
	public Motorcycle(String type, double km, String damage, Date arrdate)
	{
	...
	{
		return "Motorcycle [Type = " + super.gettype() + ", KM = " + km + ", Damage = " + damage+ ", Arrival Date = " + arrdate + "]"; //information we extract from the function
		}
	}
